...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Tactical Empathy API',
    'DESCRIPTION': 'API for managing conversations and debates with AI',
    'VERSION': '1.0.0',
    ...
    # Only include API endpoints in documentation, exclude web interface
